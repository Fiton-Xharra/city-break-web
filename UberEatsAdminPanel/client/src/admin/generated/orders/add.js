...
const AddNewOrdersView = () => {
    ...
    const createOrders = async (data, setSubmitting) => {
        console.log(JSON.stringify(data));
        setIsLoading(true);
        const response = await fetch(baseAPIURL + 'order/add', {
    ...
    return (
        ...
        // }
                ...
                onSubmit={(values, { setSubmitting }) => {
                    createOrders(values, setSubmitting);
                }}
            >
                {({
                values,
            ...
            {/* <div className="FormFieldContainer">
                ...
                <div className="FormArrayField">
                    <IMObjectInputComponent 
                        ...
                        valuePlaceholer="Delivery Address Value" 
                        ...
                        initialData={{'city': "",'country': "",'email': "",'line1': "",'line2': "",'name': "",'phone': "",'postal code': "",}}
                    />
        ...
        <div className="FormFieldContainer">
            ...
            <div className="FormFieldContainer">
                ...
                <IMStaticSelectComponent
                    options={["Order Placed","Order Cancelled","Order Accepted","Order Completed"]}
                    name="status"
...
export default AddNewOrdersView;